...
const subjectsData = {
  ...
  subj3: { 
   title: 'Circuit 1', icon: '📖',
    ...
    { label: 'Engineering circuit analysis', url: 'academic papers/circuits 1 and 2/solutions of engineering circuit analysis 9th edition.pdf', cover: 'books mockups/Fundamentals of electrical cicrcuits.png' }
    { label: 'Engineering circuit analysis solutions', url: 'academic papers/circuits 1 and 2/Introductory circuit analysis 13th edition.pdf', cover: 'books mockups/Fundamentals of electrical cicrcuits.png' }
    { label: 'Introductory circuit analysis', url: 'academic papers/circuits 1 and 2/Introductory circuit analysis 13th edition.pdf', cover: 'books mockups/Fundamentals of electrical cicrcuits.png' }      
    { label: 'electric circuits', url: 'academic papers/circuits 1 and 2/electric circuits 11th edition.pdf', cover: 'books mockups/Fundamentals of electrical cicrcuits.png' }
    { label: 'تحليل الدوائر الكهربائية والالكترونية', url: 'academic papers/circuits 1 and 2/تحليل الدوائر الكهربائية والالكترونية.pdf', cover: 'books mockups/Fundamentals of electrical cicrcuits.png' }
    { label: 'تحليل الدوائر الكهربائية والالكترونية حلول', url: 'academic papers/circuits 1 and 2/حلول كتاب تحليل الدوائر الكهربائية والالكترونية.pdf', cover: 'books mockups/Fundamentals of electrical cicrcuits.png' }],
