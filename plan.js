...
const subjectsData = {
  ...
  subj25: {
    ...
    { label: 'Electrical components', url: 'academic papers/protection/summaries/سلايدات المادة/Others/elcromechancal components devices.pdf' }, ], videos: [], mid: [{ label: '2025',  url: 'academic papers/protection/past papers/ميد 2025.pdf'},{ label: '2025',  url: 'academic papers/protection/past papers/mid 2025 exam.pdf'},{ label: '2024',  url: 'academic papers/protection/past papers/mid exam 2024.pdf'},{ label: '2024',  url: 'academic papers/protection/past papers/mid 2024.pdf'},{ label: 'ميد',  url: 'academic papers/protection/past papers/ميد.pdf'},{ label: '2016',  url: 'academic papers/protection/past papers/ميد 2016.pdf'},{ label: '2015',  url: 'academic papers/protection/past papers/ميد 2015.pdf'},{ label: 'Fuse MCQs',  url: 'academic papers/protection/past papers/530624671-Electrical-Fuse-MCQ-E-Book-PDF.pdf'},{ label: 'Circuit breakers MCQs part 2',  url: 'academic papers/protection/past papers/circuit breakers mcqs.pdf'},{ label: 'Circuit breakers MCQs',  url: 'academic papers/protection/past papers/Circuit Breaker - Multiple Choice Questions.pdf'},], final: [{ label: 'شاشات',  url: 'academic papers/protection/past papers/فاينل شاشات.pdf'},{ label: 'Test bank',  url: 'academic papers/protection/past papers/546356653-SAP-MCQ-Question-Bank-E2-D.pdf'},{ label: 'Switch gear test bank',  url: 'academic papers/protection/past papers/protection and switch gear test bank.pdf'},{ label: 'Switches MCQs',  url: 'academic papers/protection/past papers/Electrical Switches Objective Questions.pdf'},{ label: 'Sensors and Transducers MCQs',  url: 'academic papers/protection/past papers/Sensors and Transducers Objective Questions.pdf'},]
  },
  subj26: {
    title: 'SCADA', icon: '📊',
    books: [],
