...
const subjectsData = {
  ...
  subj3: { 
    ...
    { label: 'Engineering circuit analysis', url: 'academic papers/circuits 1 and 2/solutions of engineering circuit analysis 9th edition.pdf', cover: 'a' }
    { label: 'Engineering circuit analysis solutions', url: 'academic papers/circuits 1 and 2/Introductory circuit analysis 13th edition.pdf', cover: 'a' }
    { label: 'Introductory circuit analysis', url: 'academic papers/circuits 1 and 2/Introductory circuit analysis 13th edition.pdf', cover: 'a' }      
    { label: 'electric circuits', url: 'academic papers/circuits 1 and 2/electric circuits 11th edition.pdf', cover: 'a' }
    { label: 'تحليل الدوائر الكهربائية والالكترونية', url: 'academic papers/circuits 1 and 2/تحليل الدوائر الكهربائية والالكترونية.pdf', cover: 'a' }
    { label: 'تحليل الدوائر الكهربائية والالكترونية حلول', url: 'academic papers/circuits 1 and 2/حلول كتاب تحليل الدوائر الكهربائية والالكترونية.pdf', cover: 'a' }],
