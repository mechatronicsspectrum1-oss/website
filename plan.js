...
const subjectsData = {
  ...
  subj3: { 
   title: 'Circuit 1', icon: '📖',
    ...
    { label: 'Engineering circuit analysis', url: 'academic papers/circuits 1 and 2/Engineering circuit analysis 9th edition.pdf', cover: 'books mockups/Fundamentals of electrical cicrcuits.png' },
    { label: 'Engineering circuit analysis solutions', url: 'academic papers/circuits 1 and 2/solutions of engineering circuit analysis 9th edition.pdf', cover: 'books mockups/Fundamentals of electrical cicrcuits.png' },
